            ...
            <table class="table shadow p-3 mb-5 bg-body-tertiary rounded table-striped text-center ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;">{{ $value['show_date'] }}</td>
                        ...
                        <td style="line-height: 93px;">
                            @if($value['status'] == "Chờ thanh toán")
                                <a onclick="return confirm('Bạn có muốn thanh toán vé này không?')" href="index.php?act=confirmPayment&id_order={{ $value['id_order'] }}"><input type="button" class="btn btn-primary" id="btn_confirm" style="width: 150px;" value="Xác nhận thanh toán"></a>
                            @elseif($value['status'] == "Đã thanh toán")
                                <a onclick="return confirm('Bạn có muốn in vé này không?')" href="index.php?act=process_print&id_order={{ $value['id_order'] }}"><input type="button" class="btn btn-primary" id="btn_confirm" style="width: 150px; background: #fd9351; border: none;" value="Xác nhận in vé"></a>
                            @else
